class DropBoxController{
    constructor(){
        ...
        this.divEl = document.querySelector('.col-md-9');
    ...
    connectFirebase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyBtj9I2WU1WFIk-WxFpChDsX5iniKL16U0",
            authDomain: "dropbox-clone-5e443.firebaseapp.com",
            databaseURL: "https://dropbox-clone-5e443.firebaseio.com",
            projectId: "dropbox-clone-5e443",
            storageBucket: "dropbox-clone-5e443.appspot.com",
            messagingSenderId: "264691008158",
            appId: "1:264691008158:web:1afbb2f2704961cf57718f",
            measurementId: "G-6D1SERXSQ7"
        };
    ...
    ajax(url, method = 'GET', formData = new FormData, onprogress = ()=>{}, 
    onloadstart = ()=>{}){
    ...
    uploadTask(files){
        ...
        [...files].forEach(file => {
            ...
            // faz o upload dos arquivos no servidor
            /* 
                let formData = new FormData();
    ...
    renderNav(){
        ...
        for (let i = 0; i < this.currentFolder.length; i++) {
            ...
            if((i+1) == this.currentFolder.length){
                ...
                span.innerHTML = `<span>${folderName}</span>`;
        ...
        this.getFirebaseRef().on('value', snapshot =>{
            ...
            snapshot.forEach(item => {
                ...
                if(file.type){
                    ...
                    let li = this.getFileView(file, key);
